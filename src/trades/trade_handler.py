...
class TradeHandler:
    ...
    def close_trade(self, trade):
        ...
        trade.profit_loss = (trade.sell_price * trade.share_qty) - trade.investment_total
    ...
    def analyse_open_trades(self):
        ...
        # POST requests to /trades return the unique trade_id generated by the database assign it to the trade
        # object for easy future reference.
        request_handler.put(f"/trades", {"open_trades": json_open_trades_array, "closed_trades": json_closed_trades_array})
